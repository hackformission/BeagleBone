...
submitButton.addEventListener("click", function () {
  ...
  var eventData = {
      ...
      "timestamp" : document.getElementById("eventDate").value.split("-")[1] + "-" + document.getElementById("eventDate").value.split("-")[0] + "-" + document.getElementById("eventDate").value.split("-")[2] + " " + document.getElementById("eventHours").value + document.getElementById("eventMinutes").value,
